...
CREATE TYPE public.app_role AS ENUM ('citizen', 'official', 'analyst', 'volunteer');
...
-- Function to handle new user signup (creates profile and assigns default citizen role)
